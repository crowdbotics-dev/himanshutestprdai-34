"""
Django settings for himanshutestprdai_34 project.
...
ROOT_URLCONF = 'himanshutestprdai_34.urls'
...
WSGI_APPLICATION = 'himanshutestprdai_34.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "himanshutestprdai_34 API",
    "DESCRIPTION": "API documentation for himanshutestprdai_34 App",
    "VERSION": "v1",
}
